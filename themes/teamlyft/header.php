...
<!-- 3d nav -->
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/style.css" media="screen" type="text/css" />
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/modernizr.js"></script> <!-- Modernizr -->
<!-- 3d nav -->

<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/font-awesome/css/font-awesome.min.css" media="screen" type="text/css" />
...
<header class="cd-header">
	<a href="/" class="cd-logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/logo_small_white.png" alt="Logo"></a>
